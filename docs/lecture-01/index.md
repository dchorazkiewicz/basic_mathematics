...
section_links:
  ...
  - { id: functions, title: Functions generate points }
...
--8<-- "lecture-01/sections/02-cartesian-construction.md"
--8<-- "lecture-01/sections/03-coordinates.md"
--8<-- "lecture-01/sections/04-distance.md"
--8<-- "lecture-01/sections/05-graphs.md"
