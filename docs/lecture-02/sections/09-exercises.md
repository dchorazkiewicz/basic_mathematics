...
1. Let $A=(1,2)$ and $B=(5,-1)$. Compute $[\overrightarrow{AB}]$. Draw equal representatives beginning at $O=(0,0)$ and $P=(-2,3)$, and find their endpoints.
...
10. Starting from $P=(2,-1)$, apply $[3,2]$, $[-1,4]$, and $-2[3,2]$. Find the endpoint in two ways.
