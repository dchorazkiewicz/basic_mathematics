---
title: Addition, opposite vectors, and subtraction
---

# Addition, opposite vectors, and subtraction
...
The first change is represented by the anchored vector $\overrightarrow{PQ}$ and the second by $\overrightarrow{QR}$. The same journey also produces one direct change from $P$ to $R$, represented by $\overrightarrow{PR}$.

<div class="statement">
  <span class="statement-label">The problem</span>
...
<figure class="figure-panel" data-fullscreen-panel tabindex="0">
  ...
  <div class="figure-stage"><div id="vector-chain-board" class="jxgbox" data-vector-chain></div></div>
...
Substitute the expression for $Q$ into the formula for $R$:
...
At this point we are still using coordinatewise addition of Cartesian points. By associativity,
...
These coordinates depend only on the two free vectors $\mathbf a$ and $\mathbf b$, not on the starting point $P$. We therefore define
...
<figure class="figure-panel" data-fullscreen-panel tabindex="0">
  ...
  <div class="figure-stage"><div id="vector-subtraction-board" class="jxgbox" data-vector-subtraction></div></div>
  <div class="relation-readout" data-vector-subtraction-readout></div>
  <figcaption class="figure-caption">The opposite vector reverses orientation without changing length. Subtraction is ordinary vector addition with this reversed vector.</figcaption>
</figure>
...
<span class="statement-label">Points and vectors</span>
